        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-8">
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:bg-gray-50 transition-colors">
                    ...
                    <p className="text-sm text-gray-500 mb-4">Supports .csv, .xls, and .xlsx files</p>
                    
                    <a 
                        href="/issue_template.csv" 
                        download="issue_template.csv"
                        className="text-sm text-blue-600 hover:text-blue-800 hover:underline inline-flex items-center gap-1 mb-6"
                    >
